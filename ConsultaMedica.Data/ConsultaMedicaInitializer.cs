    ...
    public class ConsultaMedicaInitializer : DropCreateDatabaseAlways<ConsultaMedicaContext>
    {
        protected override void Seed(ConsultaMedicaContext context)
        {
            ...
            var patients = new List<Patient> {
                new Patient { CPF = "100.000.000-00", Name = "Alex Salvador", BirthDate = DateTime.Parse("2001-01-01"), Email = "alex@gmail.com", Phone = "(81) 9 8232-2313", Sex = Sex.MASCULINE },
                new Patient { CPF = "200.000.000-00", Name = "Rafaela Garrucha", BirthDate = DateTime.Parse("1989-12-25"), Email = "rafaela@gmail.com", Phone = "(55) 9 8743-6643", Sex = Sex.FEMININE },
                new Patient { CPF = "300.000.000-00", Name = "Elisandro Dias", BirthDate = DateTime.Parse("1991-03-13"), Email = "elisandro@hotmail.com", Phone = "(51) 9 0394-3189", Sex = Sex.MASCULINE },
            };
